...
class UriTest extends TestCase
{
    ...
    {
        $resolvedUri = Uri::resolve($baseUri, $relativeUri);
    ...
    public static function provideResolveUri(): iterable
    {
        ...
        yield 'Single-level relative path' => ['https://example.com/foo', 'bar', 'https://example.com/foo/bar'];
        ...
        yield 'Keep query string and fragment' => ['https://example.com/foo/?foo=bar#baz', '/bar', 'https://example.com/bar?foo=bar#baz'];
