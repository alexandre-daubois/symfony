...
class ArrayShapeGeneratorTest extends TestCase
{
    public function testInvalidFormatThrows()
    {
        ...
        $this->expectExceptionMessage('Unsupported format to generate array shape. Expected one of "phpdoc", "jetbrains_attribute", got "invalid_format".');
    ...
    public function testJetbrainsArrayShapeHandlesNodeTypes(NodeInterface $node, string $expected)
    {
        ...
        $this->assertStringContainsString($expected, ArrayShapeGenerator::generate($arrayNode, ArrayShapeGenerator::FORMAT_JETBRAINS_ATTRIBUTE));
    }
    ...
    public function testPrototypedArrayNodeJetbrainsArrayShape()
    {
        $prototype = new PrototypedArrayNode('proto');
        $prototype->setPrototype(new StringNode('child'));
        ...
        $expected = "'proto' => ['string'],";

        $this->assertStringContainsString($expected, ArrayShapeGenerator::generate($root, ArrayShapeGenerator::FORMAT_JETBRAINS_ATTRIBUTE));
    }
    ...
    public function testJetbrainsArrayShapeHandlesDefaultValueNode()
    {
        ...
        $expected = "'node' => 'bool', /* Default: true */";
    ...
    public function testJetbrainsArrayShapeHandlesAllDocOnNode()
    {
        ...
        $expected = "'node' => 'bool', /* Deprecated: The \"node\" option is deprecated. This is a boolean node. Default: true */";
    ...
    public function testJetbrainsShape()
    {
        ...
        $this->assertStringMatchesFormat('#[ArrayShape(%A)]', ArrayShapeGenerator::generate($root, ArrayShapeGenerator::FORMAT_JETBRAINS_ATTRIBUTE));
    }
