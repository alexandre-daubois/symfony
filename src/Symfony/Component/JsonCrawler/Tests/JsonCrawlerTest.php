...
namespace Symfony\Component\JsonCrawler\Tests;

use PHPUnit\Framework\TestCase;
use Symfony\Component\JsonCrawler\JsonCrawler;
...
JSON);
    ...
    {
        $result = self::getBookstoreCrawler()->find("$.store.book[?search(@.title, 'of Honour')]");
